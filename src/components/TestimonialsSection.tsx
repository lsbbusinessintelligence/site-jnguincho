...
const reviewImages = [
  { src: "/images/jn-guincho/JNGUINCHOAVALIACAO01.jpg", alt: "Depoimento real de cliente - avaliação 1" },
  { src: "/images/jn-guincho/JNGUINCHOAVALIACAO02.jpg", alt: "Depoimento real de cliente - avaliação 2" },
  { src: "/images/jn-guincho/JNGUINCHOAVALIACAO03.jpg", alt: "Depoimento real de cliente - avaliação 3" },
  { src: "/images/jn-guincho/JNGUINCHOAVALIACAO04.jpg", alt: "Depoimento real de cliente - avaliação 4" },
  { src: "/images/jn-guincho/JNGUINCHOAVALIACAO05.jpg", alt: "Depoimento real de cliente - avaliação 5" },
  { src: "/images/jn-guincho/JNGUINCHOAVALIACAO06.jpg", alt: "Depoimento real de cliente - avaliação 6" },
];
    ...
    <div className="container">
      ...
      >
        ...
        <p className="text-muted-foreground text-lg">
          Clientes satisfeitos com o atendimento 24h, profissionalismo e preço justo da JN Guincho.
        </p>
