...
const reviewImages = [
  { src: "/images/luizfalcirolli/CLIENTE_LUIZ_ELETRICISTA_07.jpeg", alt: "Depoimento real de cliente - avaliação 1" },
  { src: "/images/luizfalcirolli/CLIENTE_LUIZ_ELETRICISTA_08.jpeg", alt: "Depoimento real de cliente - avaliação 2" },
  { src: "/images/luizfalcirolli/CLIENTE_LUIZ_ELETRICISTA_09.jpeg", alt: "Depoimento real de cliente - avaliação 3" },
];
    ...
    <div className="container">
      ...
      >
        ...
        <p className="text-muted-foreground text-lg">
          Quem contrata o Sr. Luiz destaca segurança, rapidez e excelência técnica nos serviços elétricos.
        </p>
